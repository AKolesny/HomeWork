...
public class Flights {
    ...
    public Flights(String flight_id, String flight_no, String scheduled_departure,
                   String scheduled_departure_local, String scheduled_arrival,
                   String scheduled_arrival_local, String scheduled_duration,
                   String departure_airport, String departure_airport_name,
                   String departure_city, String arrival_airport, String arrival_airport_name,
                   String arrival_city, String status, String aircraft_code,
                   String actual_departure, String actual_departure_local, String actual_arrival,
                   String actual_arrival_local, String actual_duration) {
